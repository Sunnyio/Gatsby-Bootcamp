        ...
        <header className={headerStyle.header}>
            ...
            <nav>
                <ul className={headerStyle.navList}>
                    ...
                    <li><Link className={headerStyle.navItem} activeClassName={headerStyle.activeNavItem} to="/contact">Contact Me</Link></li>
                    <li><Link className={headerStyle.navItem} activeClassName={headerStyle.activeNavItem} to="/blog">All Blogs</Link></li>
                </ul>
            </nav>
        </header>
    )
